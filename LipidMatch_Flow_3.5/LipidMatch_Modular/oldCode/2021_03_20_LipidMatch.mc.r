...
if (ManuallyInputVariables==TRUE){
  ...
  #parametersDirectory
  parametersDir <- "/home/jmun0029/Documents/data1/LCMS/Lipidomics/2020/S1P-IS-test"
  #parametersDir <- "/home/jmun0029/Documents/data2/GitHub/testdata"
  parametersFile <- file.path(parametersDir, "LIPIDMATCH_PARAMETERS_Thermo_QExactive_Ubuntu.csv")
...
#    foreach (c = 1:length(ddMS2POS_in), .options.multicore=mcoptions) %dopar% {
  ...
  if(runNegddMS & runPosddMS){
    remove_duplicates(data,row_start,adduct_col,annotation_col,window)
  }
